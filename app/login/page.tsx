...
const PageLogin = () => {
	return (
		<div
			className='p-6 max-h-screen min-h-screen flex justify-center items-center'>
      <div className='relative p-6 w-full h-[calc(100vh-48px)] flex justify-center items-center rounded-[48px] overflow-hidden'>
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, #FFFFEA 0%, rgba(255, 227, 173, 0.8) 15.89%, #FFE7C8 62.5%, rgb(255 246 245 / 0%) 100%), radial-gradient(50% 74.51% at 50% 100%, rgba(255, 255, 255, 0.5) 24.09%, rgba(255, 255, 255, 0.16) 100%)'
          }}>
        </div>
        <div
          className='relative px-6 pb-6 pt-14 bg-white rounded-2xl'
          style={{
            boxShadow: 'rgba(255, 255, 255, 0.3) 0px 0px 0px 10px, rgba(0, 0, 0, 0.3) 0px 4px 8px -4px',
            border: '1px solid',
            borderImageSource: 'linear-gradient(180deg, rgba(235, 235, 235, 0) 0%, #EBEBEB 100%)'
          }}
        >
          <div
            className='bg-container-logo absolute -top-8 left-0 right-0 mx-auto size-16 rounded-xl'>
            <Image
